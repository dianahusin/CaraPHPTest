    ...
    <div class="modal-dialog modal-xl" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="createmodal">Add New Company</h5>
                        ...
                        <div class="col-md-6">
                            <div role="group" class="form-group">
                                <div class="form-row">
                                    ...
                                    <input type="text" class="form-control" name="name" placeholder="Enter the company name">
                                </div>
                            </div>
                            <div role="group" class="form-group">
                                <div class="form-row">
                                    <label class="form-label">Email<span class="text-danger label-required"></span></label>
                                    <input type="email" class="form-control" name="email" placeholder="Enter the company email">
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div role="group" class="form-group">
                                <div class="form-row">
                                    ...
                                    <input type="text" class="form-control" name="website" placeholder="Enter the company website">
                                </div>
                            </div>
                            <div role="group" class="form-group">
                                <div class="form-row">
